...
//====================================================软件 IIC 驱动====================================================
#define DL1B_SOFT_IIC_DELAY         ( 2000 )                                     // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
#define DL1B_SCL_PIN                ( BSP_IO_PORT_05_PIN_15 )                   // 软件 IIC SCL 引脚 连接 DL1B 的 SCL 引脚
#define DL1B_SDA_PIN                ( BSP_IO_PORT_05_PIN_14 )                   // 软件 IIC SDA 引脚 连接 DL1B 的 SDA 引脚

#define DL1B_XS_PIN                 ( BSP_IO_PORT_04_PIN_02 )

#define DL1B_INT_ENABLE             ( 1 )                                       // 是否启用 INT 引脚 启用则会自动更新数据
#if DL1B_INT_ENABLE
//#define DL1B_INT_PIN                ( BSP_IO_PORT_07_PIN_04 )
#define DL1B_INT_CHANNEL            ( 26 )
#endif
...
extern volatile uint8 dl1b_finsh_flag;
extern volatile uint16 dl1b_distance_mm;
