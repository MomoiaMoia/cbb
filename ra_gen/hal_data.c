...
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x5b8d80,
  .duty_cycle_counts = 0x2dc6c0, .source_div = (timer_source_div_t) 0, .channel = 7, .p_callback = NULL,
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x5b8d80,
  .duty_cycle_counts = 0x2dc6c0, .source_div = (timer_source_div_t) 0, .channel = 8, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
