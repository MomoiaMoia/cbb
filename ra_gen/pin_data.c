...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] =
        ...
        { .pin = BSP_IO_PORT_01_PIN_04, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
          ...
          { .pin = BSP_IO_PORT_04_PIN_02, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
          ...
          { .pin = BSP_IO_PORT_04_PIN_09, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
                  | (uint32_t) IOPORT_CFG_NMOS_ENABLE | (uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
                  | (uint32_t) IOPORT_CFG_PORT_OUTPUT_HIGH) },

          { .pin = BSP_IO_PORT_04_PIN_10, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
                  | (uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT | (uint32_t) IOPORT_CFG_PORT_OUTPUT_HIGH) },
          ...
          { .pin = BSP_IO_PORT_05_PIN_14, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HS_HIGH
                  | (uint32_t) IOPORT_CFG_NMOS_ENABLE | (uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
                  | (uint32_t) IOPORT_CFG_PORT_OUTPUT_HIGH) },
          ...
          { .pin = BSP_IO_PORT_07_PIN_04, .pin_cfg = ((uint32_t) IOPORT_CFG_IRQ_ENABLE
                  | (uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },

          { .pin = BSP_IO_PORT_07_PIN_06, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },

          { .pin = BSP_IO_PORT_07_PIN_07, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT
                  | (uint32_t) IOPORT_CFG_PULLUP_ENABLE) },
          ...
          { .pin = BSP_IO_PORT_11_PIN_03, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) },

          { .pin = BSP_IO_PORT_11_PIN_04, .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN
                  | (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9) }, };
