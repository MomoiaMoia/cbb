...
__attribute__((aligned(16))) uint8_t sub_0000_arena[209984];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0000_fast_scratch[209984];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 6960 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 209984 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 209984;

  // Buffer sub_0000_fast_scratch with size 209984 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[2] = 209984;

  // Buffer input_tensor_0 with size 76800 and address: 102400
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0000_arena+102400);
  base_addrs_size[3] = 76800;

  // Buffer output_tensor_0 with size 25600 and address: 107584
  if (clean_outputs) {
    memset(sub_0000_arena + 107584, 0, 25600);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0000_arena+107584);
  base_addrs_size[4] = 25600;

  // Buffer output_tensor_1 with size 25600 and address: 133184
  if (clean_outputs) {
    memset(sub_0000_arena + 133184, 0, 25600);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0000_arena+133184);
