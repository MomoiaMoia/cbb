...
const TensorInfo sub_0002_tensors[] = {
  ...
  { "model_9_tf_concat_124_concat_70200", 4, 51200, "INPUT_TENSOR", 0xc800 },
  { "model_9_tf_math_multiply_258_Mul_70206", 5, 51200, "OUTPUT_TENSOR", 0x19000 },
};

const size_t sub_0002_tensors_count = sizeof(sub_0002_tensors) / sizeof(sub_0002_tensors[0]);

// Addresses for each input and output buffer inside of the arena
const uint32_t sub_0002_address_model_9_tf_concat_124_concat_70200 = 0xc800;
const uint32_t sub_0002_address_model_9_tf_math_multiply_258_Mul_70206 = 0x19000;
