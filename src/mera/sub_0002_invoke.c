...
__attribute__((aligned(16))) uint8_t sub_0002_arena[153600];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0002_fast_scratch[153600];
...
int sub_0002_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0002_model with size 2192 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0002_model_data;
  base_addrs_size[0] = sub_0002_model_data_size;
  // Buffer sub_0002_arena with size 153600 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0002_arena+0);
  base_addrs_size[1] = 153600;

  // Buffer sub_0002_fast_scratch with size 153600 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0002_arena+0);
  base_addrs_size[2] = 153600;

  // Buffer input_tensor_0 with size 51200 and address: 51200
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0002_arena+51200);
  base_addrs_size[3] = 51200;

  // Buffer output_tensor_0 with size 51200 and address: 102400
  if (clean_outputs) {
    memset(sub_0002_arena + 102400, 0, 51200);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0002_arena+102400);
