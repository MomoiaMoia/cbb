...
#include "sub_0006_command_stream.h"
#include "sub_0006_model_data.h"
...
__attribute__((aligned(16))) uint8_t sub_0006_arena[76800];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0006_fast_scratch[76800];
...
int sub_0006_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0006_model with size 5760 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0006_model_data;
  base_addrs_size[0] = sub_0006_model_data_size;
  // Buffer sub_0006_arena with size 76800 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0006_arena+0);
  base_addrs_size[1] = 76800;

  // Buffer sub_0006_fast_scratch with size 76800 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0006_arena+0);
  base_addrs_size[2] = 76800;

  // Buffer input_tensor_0 with size 25600 and address: 25600
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0006_arena+25600);
  base_addrs_size[3] = 25600;

  // Buffer output_tensor_0 with size 25600 and address: 51200
  if (clean_outputs) {
    memset(sub_0006_arena + 51200, 0, 25600);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0006_arena+51200);
  base_addrs_size[4] = 25600;

  // Command stream data
  cms_data = (uint8_t*)sub_0006_command_stream;
  cms_size = (int) sub_0006_command_stream_size;
