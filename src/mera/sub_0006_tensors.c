...
const TensorInfo sub_0006_tensors[] = {
  ...
  { "model_4_tf_concat_3_concat_70241", 4, 25600, "INPUT_TENSOR", 0x6400 },
  { "model_4_tf_math_multiply_25_Mul_70247", 5, 25600, "OUTPUT_TENSOR", 0xc800 },
};

const size_t sub_0006_tensors_count = sizeof(sub_0006_tensors) / sizeof(sub_0006_tensors[0]);

// Addresses for each input and output buffer inside of the arena
const uint32_t sub_0006_address_model_4_tf_concat_3_concat_70241 = 0x6400;
const uint32_t sub_0006_address_model_4_tf_math_multiply_25_Mul_70247 = 0xc800;
