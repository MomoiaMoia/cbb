...
void hal_entry(void)
{
    ...
    ips200_show_string(92, 112, "Present by Momoia");
    ...
    while (true) {
        ...
        YoloDetectionResult *det_result = YoloApi_RunYolo(&yolo_api, g_rgb_buffer);

        /*---- Convert RGB888 -> RGB565 and display on IPS200 ----*/
        // rgb888_to_rgb565_buffer(g_rgb_buffer, g_rgb565_buffer, SCC8660_W * SCC8660_H);
