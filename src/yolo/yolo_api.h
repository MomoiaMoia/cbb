// yolo_api.h — YOLO object detection API (NPU inference)
// Uses ethos-u NPU via mera/model; 160x160 input, 500 boxes, NMS post-processing
#ifndef YOLO_API_H
#define YOLO_API_H
...
// Filter detections by minimum width (discard too-small/far targets)
void YoloApi_FilterByWidth(YoloDetectionResult *result, float min_width);

// Filter detections by centre-pixel RGB colour range
